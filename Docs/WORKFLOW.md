...
| A running server, by hand | `Scripts/smoke.sh` | ~5s | A real socket, `/health`, and migrations against a database that already has rows — none of which the suite touches |
